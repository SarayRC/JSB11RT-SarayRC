...
app.put('/users/:idUser/password', isAuth, canEditUser, editUserPassword);
    //Middelware. Modificar datos por usuario logueado. En el mismo método se han importado dos funciones, isAuth y modifyUser
...
app.post('/register/experience', newExperience, isAuth);
    //Modificar experiencia
app.post('/modifyExperience/:idExperience', isAuth, canEditExperience, modifyExperience)
